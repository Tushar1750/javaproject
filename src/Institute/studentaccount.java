...
Connection con = DriverManager.getConnection("jdbc:mysql://localhost/Institute","root","");
         ...
         String query ="select student_name From students where student_id='"+Login.uid.getText()+"'";
            ResultSet rs = stmt.executeQuery(query);
            while(rs.next()){
          jLabel2.setText(rs.getString("student_name"));
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1361, 704));
        ...
        jLabel3.setText(" Student Account");
